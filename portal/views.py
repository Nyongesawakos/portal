...
def upload_students(request):
    ...
    required = ["reg_no", "name", "email", "grade","fee_paid", "arrears", "assessment_no", "UPI", "emergency_contact"]
    ...
    return HttpResponse({"success": "Students uploaded"})
...
def deleteStudent(request, pk):
    ...
    if request.method == 'POST':
        name = Student.name 
        remove.delete()
        messages.success(request,  f'{Student.name} Student deleted successfully')
        return redirect('student_list')
